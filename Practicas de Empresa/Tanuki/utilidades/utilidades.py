...
def obtenerDispositivos():
    # Arranca adb en caso de no estar arrancado
    subprocess.run("adb start-server", shell=True, capture_output=True, text=True)
    ...
    return dispositivos
    # TODO - al eliminar la palabra device de la salida del comando ej: emulador123    device. el programa no distingue entre el dispositivo con y sin permisos y fallara si no se tiene permisos
